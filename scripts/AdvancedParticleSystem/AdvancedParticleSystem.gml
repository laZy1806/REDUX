		...
		if _length > 0 {
			...
			if _length > part_system_max_count {
				...
				repeat(_unnecessary_particles_number) {
					...
					//And delete it ------ personally modified to delete last particle made
					//array_delete(particle_array, _part, 1);
					// my own personal modification, removing last ever created particle
					array_delete(particle_array, _length--, 1);
				}
				
				//array_delete(particle_array, _length - 1, 1)
