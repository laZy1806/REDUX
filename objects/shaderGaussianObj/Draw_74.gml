...
if (!surface_exists(srf_ping)) srf_ping = surface_create(gui_w * sfr_scale, gui_h * sfr_scale);
if (!surface_exists(srf_pong)) srf_pong = surface_create(gui_w * sfr_scale, gui_h * sfr_scale);

if (sfr_scale != sfr_scale_prev) {
	surface_resize(srf_ping, gui_w * sfr_scale, gui_h * sfr_scale)
	surface_resize(srf_pong, gui_w * sfr_scale, gui_h * sfr_scale)
...
shader_set(shader) 
	...
	draw_surface_stretched(srf_ping, 0, 0, gui_w, gui_h)
