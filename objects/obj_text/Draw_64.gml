...
if instance_exists(obj_OverworldDialogue) {
	...
	if isHead x = obj_OverworldDialogue.x + 200
	else x = obj_OverworldDialogue.x + 100
...
var letter_spacing = DefaultSpacing;
	if show {
		...
		if isHead draw_sprite_ext(headSprite, headQueue[NumInQueue], obj_OverworldDialogue.x + 120, obj_OverworldDialogue.y + 90, 2.5, 2.5, 0, c_white, 1)
